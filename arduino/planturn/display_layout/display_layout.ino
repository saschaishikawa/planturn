 ...
 * ---
 * 
 * - Primitive clock-like rotation with continuious microstepping (needs improvement)
 * - Provide display layout with degrees (DEG), moisture reading (H20), brighness (LUX), 
 *   rotations per day (RPD), and weight (WGT) placeholders
 */
#include <Wire.h>
